...
$query1=mysqli_query($link,"INSERT INTO Company VALUES ('', '$oname','$mail','$pas','$typ','$role')");
...
<label>Owner Name:</label> <input type="text" name="name" class="form-control"><br>
...
<label>Company Type:</label> <input type="text" name="typ" class="form-control"><br>
