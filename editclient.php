...
$query3=mysqli_query($link,"update client set cl_id='$cl_id', district='$district' ,email='$email',password='$password' ,role='$role' where cl_id='$cl_id'");
if($query3)
{
...
$query1=mysqli_query($link,"select * from client where cl_id='cl_id'");
if(!$query1)
{
echo("Error description: " . mysqli_error($link));
}
...
<form method="post" action="">
 ...
 <tr> 
<td  align="right"><b>Client id:</b></td>   <td><input type="text" name="cl_id" /></td>
            </tr>
